...
var MateosBgCanvas = {
    ...
    draw: function draw() {
        ...
        var cd = cv.createImageData(canvas.width, canvas.height);
        var cdData = cd.data;
...
},{"jquery":8,"live-remote-api":9,"live-remote-params":20}],4:[function(require,module,exports){
'use strict';

var _jquery = require('jquery');

var _MateosUi = require('./MateosUi');
...
},{"./MateosUi":2,"jquery":8,"live-remote-api":9}],5:[function(require,module,exports){
"use strict";
...
var RemoteApi = (function () {
    function RemoteApi(info) {
        this.info = info;
    }
    RemoteApi.prototype.onError = function (callback) {
        this.errorListener = callback;
    };
    RemoteApi.prototype.get = function (property, callback) {
        var self = this;
        socket_1.socket.send("get " + this.info.key + " " + property, function (err, val) {
            if (err)
                self.setError(err);
            else
                callback(val);
    ...
    RemoteApi.prototype.set = function (property, value) {
        socket_1.socket.send("set " + this.info.key + " " + property + " " + value);
    };
    RemoteApi.prototype.observe = function (property, callback) {
        var self = this;
        socket_1.socket.send("observe " + this.info.key + " " + property, function (err, val) {
            if (err)
                self.setError(err);
            else
                callback(val);
    ...
    RemoteApi.prototype.call = function (name, params, callback) {
        var self = this;
        var ps = "";
        if (params) {
        ...
        if (!callback)
            socket_1.socket.send("call " + this.info.key + " " + name + ps);
        else
            socket_1.socket.send("call " + this.info.key + " " + name + ps, function (err, val) {
                if (err)
                    self.setError(err);
                else
                    callback(val);
    ...
    RemoteApi.prototype.destroy = function () {
        socket_1.socket.send("destroy " + this.info.key);
    };
    RemoteApi.prototype.setError = function (err) {
        this.error = err;
        if (this.errorListener)
            this.errorListener(err);
    };
    RemoteApi.create = function (path, callback, followPath) {
        if (followPath === void 0) { followPath = false; }
        socket_1.socket.send("new " + path + " " + followPath, function (err, info) {
            if (err)
                callback(err, null);
            else
                callback(null, new RemoteApi(JSON.parse(info)));
        });
    };
    RemoteApi.info = function (path, callback) {
        socket_1.socket.send("info " + path, function (err, info) {
            if (err)
                callback(err, null);
            else
    ...
    RemoteApi.onOpen = function (action) {
        socket_1.socket.onOpen(action);
    };
    RemoteApi.echo = function (message, callback) {
        socket_1.socket.send("echo " + message, callback);
    };
    return RemoteApi;
}());
exports.RemoteApi = RemoteApi;

},{"./socket":10}],10:[function(require,module,exports){
"use strict";
...
ws.onerror = function (e) {
    ...
    open = false;
    error = e;
    error_listeners.forEach(function (l) { return callListener(l, e, "Error in onError Listener"); });
    error_listeners = [];
};
...
(function (socket) {
    function onOpen(action) {
        if (!open)
            ...
            callAction(action, "Error in onOpenAction");
    }
    ...
    function onError(callback) {
        if (!error)
            ...
            callListener(callback, error, "Error in onError Listener");
    }
    socket.onError = onError;
    function send(message, callback) {
        if (!open)
            throw "can't send websocket message: no connection!";
        var id = ++mess_id;
        if (callback)
            resp_listeners[id] = callback;
        ws.send(id + " " + message);
    }
    socket.send = send;
})(socket = exports.socket || (exports.socket = {}));
function callAction(action, err_mess) {
    try {
        action();
    }
    catch (e) {
...
function callListener(l, val, err_mess) {
    try {
        l(val);
    }
    catch (e) {
...
},{"string-split-keep":21}],11:[function(require,module,exports){
"use strict";
...
},{"./AbstractParam":12,"jquery":8}],12:[function(require,module,exports){
"use strict";
var $ = require("jquery");
...
},{"./globl":19,"jquery":8}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AbstractParam":12,"jquery":8}],14:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AbstractKnob":11}],15:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AbstractKnob":11}],16:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AbstractParam":12,"jquery":8}],17:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AbstractParam":12}],18:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AbstractParam":12,"jquery":8}],19:[function(require,module,exports){
"use strict";
...
},{"live-remote-api":9}],20:[function(require,module,exports){
"use strict";
if ("ontouchstart" in document) {
...
},{"./HSlider":13,"./Knob":14,"./PanKnob":15,"./Slider":16,"./Toggle":17,"./XYPad":18}],21:[function(require,module,exports){
"use strict"
